...
<div class="flex pt-14 justify-center items-center w-full h-screen rounded-md">
    <div class="flex w-[99%] h-[99%] no-scrollbar p-4 gap-3 overflow-y-auto">
            ...
            <div class="flex justify-between w-full h-14 rounded-md">
                <div class="flex items-center gap-4 w-auto h-full rounded-md">
                    ...
                    <el-dropdown class="inline-block">
                        <button class="inline-flex w-40 h-8 justify-between items-center px-2 gap-x-1 border border-gray-300 rounded-md bg-white/10 text-sm font-semibold text-gray-300 inset-ring-1 inset-ring-white/5 hover:bg-white/20">
